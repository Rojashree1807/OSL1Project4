...
namespace Project4
{
    public class Program
    {
        ...
        {
            students.Add(new Student("Roja", "9th"));
            students.Add(new Student("Pravin", "8th"));
            students.Add(new Student("vinmathy", "11th"));
            students.Add(new Student("Murugan", "8th"));
            students.Add(new Student("Saranya", "11th"));
            students.Add(new Student("Krishna", "10th"));
            students.Add(new Student("Balamurugan", "12th"));
